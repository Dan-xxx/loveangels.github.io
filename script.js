...
// ===== Фото из папки =====
const photos = [
  {src:"1.jpg", text:"Наш первый день вместе ❤️"},
  {src:"2.jpg", text:"Ты улыбаешься как ангел 😇"},
  {src:"3.jpg", text:"Лучший момент нашего вечера 🌙"},
  {src:"4.jpg", text:"Ты делаешь мой день ярче ☀️"}
];
...
// === 43 фото и текста ===
const allPhotos = [
  {src:"1.jpg", text:"Ты делаешь меня счастливым ❤️"},
  {src:"2.jpg", text:"Люблю твою улыбку 😍"},
  {src:"3.jpg", text:"Наш вечер под луной 🌙"},
  {src:"4.jpg", text:"Ты мое солнце ☀️"},
