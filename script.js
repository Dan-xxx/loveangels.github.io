...
// ===== Фото из папки =====
const photos = [
  {src:"photos/1.jpg", text:"Наш первый день вместе ❤️"},
  {src:"photos/2.jpg", text:"Ты улыбаешься как ангел 😇"},
  {src:"photos/3.jpg", text:"Лучший момент нашего вечера 🌙"},
  {src:"photos/4.jpg", text:"Ты делаешь мой день ярче ☀️"}
];
